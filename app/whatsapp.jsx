...
const WA_BENEFITS = [
  ...
  { ic:'users',    t:'Reply & assign from Numberline', d:'Answer from your Numberline number, hand off to a teammate, and resolve together.' },
];
  ...
  return (
    <div className="wa-flow">
      ...
      <div className="wa-flow-node biz">
        ...
        <b>Your Numberline number</b><span>{WA_BIZ_NUMBER}</span>
      </div>
      <div className="wa-flow-arrow"><WAIcon name="chevright"/></div>
  ...
  return (
    <React.Fragment>
      ...
      <section className="qx-card">
        ...
        <p className="qx-sub">Your Numberline number can accept and reply to WhatsApp Business messages. Every chat arrives in the same inbox as your texts - there’s no separate app to check.</p>
        <div className="wa-points">
          ...
          <div className="wa-point">
            ...
            <div className="wa-dest-t"><b>Reply from your Numberline number</b><span>Answer on the same business number - no personal WhatsApp account, no new number to share.</span></div>
          </div>
          <div className="wa-point">
      ...
      <section className="qx-card">
        ...
        <div className="wa-notif">
          ...
          <div className={`wa-notif-row${notif.app?'':' off'}`}>
            ...
            <div className="wa-dest-t"><b>Push to the Numberline app</b><span>Whoever’s assigned gets a push notification on their phone.</span></div>
