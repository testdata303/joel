/* ============================================================
   Numberline app - Extension Detail root + shell + flows
   ============================================================ */
...
const ACTIVITY = {
  ...
  calls:[
    ...
    { id:'c3', ext:1, line:'+1 (617) 555-0100', dir:'out',    num:'+1 (617) 555-2290', contact:'Jane Cho',      cnam:null, when:'Today, 9:30 AM', date:'2026-06-05',  ts:984, dur:'2:05', outcome:'answered', via:'Numberline app', by:'Jane Cho' },
    ...
    { id:'c5', ext:1, line:'+1 (617) 555-0100', dir:'in',     num:'+1 (508) 555-9912', contact:'Tom Reilly',    cnam:null, when:'Yesterday, 11:15 AM', date:'2026-06-04', ts:872, dur:'6:40', outcome:'answered', via:'Numberline app', by:'Jane Cho', rec:true, recSummary:"Tom asked to move his crown fitting a week later and to email the new estimate.", recTranscript:[{"at":"0:00","text":"Hey, it’s Tom Reilly. I need to push my crown fitting."},{"at":"0:30","text":"Can we do the following week instead?"},{"at":"1:10","text":"Perfect, and please email the updated estimate."}] },
...
function DestinationModal({ editing, extName, initialType, onClose, onSave }){
  ...
  const TYPES=[
    ...
    { type:'app', icon:'smartphone', t:'Mobile app', s:'Ring a teammate in the Numberline app.' },
  ];
  ...
  return (
    <Modal onClose={onClose}
      ...
      {step==='type' ? (
        ...
        <div>
          {type==='phone' ? (
            <Field label={fieldLabel} help="Any mobile, landline, or outside number. Numberline rings it directly.">
            ...
            <Field label={fieldLabel} help="Teammates ring in the Numberline mobile app.">
              <select className="select" value={value} autoFocus onChange={e=>setValue(e.target.value)}>
          ...
          <div style={rowStyle}>
            ...
            <div style={{flex:1}}>
              ...
              <p style={{color:'var(--body)',fontSize:'.82rem'}}>{enabled?'Active - calls can ring here.':'Disabled - Numberline skips this destination.'}</p>
            </div>
          ...
          <div style={rowStyle}>
            ...
            <div style={{flex:1}}>
              ...
              <p style={{color:'var(--body)',fontSize:'.82rem'}}>Before connecting, Numberline says “You have a call for {ext}. Press 1 to accept.”</p>
            </div>
          ...
          {announce && (
            <div className="note info" style={{marginTop:12}}>
              <Icon name="info"/>
              <span>Without this, a personal voicemail could answer first - Numberline would treat the call as answered and stop trying your other destinations. Call announce asks the person to press a key before connecting.</span>
            </div>
          )}

          <Field label="Ring duration" help="How long this destination rings before Numberline moves on.">
  ...
  return (
    <div className="wh-screen">
      ...
      <div className="wh-card">
        ...
        <p className="wh-note">Verify each request with the <code>X-Numberline-Signature</code> header - HMAC-SHA256 of the raw body using this secret.</p>
      </div>
...
function AIAgentSetup({ provider, extensions }){
  ...
  const STEPS=[
    ...
    { icon:'route',   t:'Connect it to Numberline by SIP', d:'Paste the agent\u2019s SIP address and API key below. Numberline hands the live call to your agent.' },
    ...
    <div className="wh-screen">
      ...
      <div className="aiset-hero">
        ...
        <div className="aiset-hero-tx">
          ...
          <p>Numberline routes the call; <b>{provider.name}</b> answers it. The AI talks to your caller in a natural voice, handles the routine stuff, and hands the call to your team - or takes a message - whenever a person is needed. You stay in control: it lives on an extension, just like a teammate.</p>
        </div>
      </div>
      ...
      <div className="wh-card">
        ...
        <p className="wh-note">Copy this from your {provider.name} agent settings. Numberline forwards the live audio to this address over SIP.</p>
      </div>
...
function IntegrationsHub({ extensions, webhookCfg, setWebhookCfg }){
  ...
  const apps=[
    ...
    { id:'zapier', name:'Zapier', icon:'sparkle', tone:'orange', desc:'Connect Numberline to 6,000+ apps with no-code automations.', soon:true },
  ];
  if(open){
    return (
  ...
  return (
    <div className="apps-screen">
      <div className="apps-head">
        <h1>Integrations</h1>
        <p>Connect Numberline to the tools your team already uses.</p>
      </div>
        ...
        {on && <>
          ...
          <div className="dir-card">
            <div className="dir-row">
              ...
              <div className="dir-row-tx"><b>Say a name</b><span>“Sales,” “Dr. Niaraki,” “Bob” - Numberline listens and connects.</span></div>
          ...
          <div className="ss-grouph">If Numberline can’t find a match</div>
                    ...
                    <div className="esys-exts">
                      ...
                      <div className="lv-row system">
                        <span className="lv-ext">
                          ...
                          <span className="lv-extmeta">
                            <b>Dial by name directory</b>
                            <span className="lv-dirnote">Built automatically from your extension names - callers speak or spell a teammate's name on the keypad and Numberline connects them to the matching extension.</span>
                          </span>
                        </span>
