      ...
      <section className="card sum-card">
        ...
        {canceled && (
          <div className="note warn" style={{margin:'0 20px 4px'}}>
            <BIcon name="info"/>
            <span><b>Scheduled to cancel.</b> Your plan stays active until <b>{renew}</b>. After that Numberline stops taking calls and texts, and your numbers are released.</span>
          </div>
        )}
        ...
        <div className="dz">
          <div className="dz-t">
            ...
            <span>{canceled
              ...
              : `Your plan stays active until ${renew}. After that, Numberline stops taking calls and texts, and your numbers are released.`}</span>
          </div>
          {canceled
...
function EditContactModal({ contact, onClose, onSave }){
  ...
  return (
    <BModal icon="building" title="Billing contact" desc="Where Numberline sends invoices and receipts." onClose={onClose}
      footer={<React.Fragment>
        <button className="btn btn-secondary" onClick={onClose}>Cancel</button>
  ...
  return (
    <BModal icon="info" title="Cancel subscription" desc={`We're sorry to see you go. Here's exactly what happens.`} onClose={onClose}
      ...
      <div className="note warn" style={{marginBottom:16}}>
        <BIcon name="info"/>
        <span>Your <b>{planName}</b> plan stays active until <b>{renew}</b>. After that, Numberline <b>stops taking calls and texts</b>, and your business numbers are <b>released</b> and can't be recovered.</span>
      </div>
