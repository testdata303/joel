/* ============================================================
   Numberline app - Extension greetings panel (exports to window)
    ...
    <div className="panel">
      ...
      {gtab==='voicemail' && (
        <EGCard icon="voicemail" title="Voicemail greeting"
          desc={`What plays when a caller reaches ${nm}'s voicemail. Numberline writes a transcript and summary of every message automatically.`}>
