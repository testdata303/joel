/* ============================================================
   Numberline app - Quick Setup extras: SMS Registration + Integrations
   ============================================================ */
    ...
    <div className="qx">
      ...
      {!connected ? (
        <div className="qx-slackconnect">
          ...
          <p>Numberline posts every new customer message into Slack in real time - so you can reply fast and never leave one waiting. Missed calls and voicemails land there too.</p>
        ...
        <React.Fragment>
          <div className="qx-slackok">
            ...
            <div className="qx-slackok-t"><b>Connected to Smilebar HQ</b><span>Posting as Numberline · connected by Bob Stevens</span></div>
          </div>
