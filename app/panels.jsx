/* ============================================================
   Numberline app - Extension Detail panels  (exports to window)
   ============================================================ */
...
function DeskPhoneInfo({ onClose, onAdd }){
  ...
  return (
    <Modal icon="monitor" title="Want a desk phone?" onClose={onClose}
      ...
      <p className="dpi-text">Numberline works with standard SIP desk phones, and this is the one we recommend - reliable, inexpensive, and it connects in about a minute when it arrives.</p>
      <div className="dpi-pick">
        ...
        <div className="dpi-pick-tx">
          ...
          <b>Yealink T31G</b>
          <span className="dpi-pick-spec">2-line desk phone · gigabit · plug-and-play with Numberline</span>
        </div>
      ...
      {section!=='advanced' && dests.length>0 && (
        <div className="avail-row col" style={{marginTop:14}}>
          <div className="avail-grouphdr">
            ...
            <p className="avail-groupsub">Numberline rings the destinations above. If they all ring out and nobody picks up, the caller gets this.</p>
          </div>
          <div className="avail-choices">
  ...
  return (
    <div className="panel">
      <div className="panel-head">
        <h2>Greeting</h2>
        <p>What callers hear when they reach {ext.name}'s voicemail. Numberline writes a transcript and summary of every message automatically.</p>
      </div>
