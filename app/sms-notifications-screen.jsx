/* ============================================================
   Numberline - Text notifications (literal, Slack-central controls)
    ...
    <div className="sn">
      ...
      <section className="ns-sec">
        ...
        <div className="sn-card ns-card">
          ...
          <React.Fragment>
              <div className="ns-row">
                <div className="ns-row-l"><span className="ns-row-ic solo"><NSIcon name="bell" /></span><div className="ns-row-t"><b>Once assigned, alert only the assignee</b><span>When someone takes a conversation, Numberline stops pinging the shared channel and the rest of the team - only the assignee hears about new replies. Avoids notification chaos.</span></div></div>
              ...
              <div className="ns-slackexp">
                ...
                <div className="ns-slackexp-b">
                  ...
                  <p>A Slack DM reaches a teammate only after they link their own Slack - one tap in their notification settings. You connect the workspace and shared channels under <b>Settings → Integrations</b>; each person links their personal account themselves, so Numberline never needs you to type anyone’s Slack username.</p>
        ...
        <p className="ns-help"><NSIcon name="info" /> {rep.solo ? 'Once someone’s assigned, Numberline keeps it personal - no channel-wide pings for every reply.' : 'New replies still post to the shared channel even after someone’s assigned - turn on the setting above to keep it to the assignee.'}</p>
      </section>
