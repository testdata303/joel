...
const ICONS = {
  ...
  image:'M3 16l5-5c.5-.5 1.5-.5 2 0l5 5 M14 14l1-1c.5-.5 1.5-.5 2 0l4 4|rect:3,3,18,18,2|circle:8.5,8.5,1.5',
  ...
  whatsapp:'M12 21a9 9 0 1 0-8.06-5L3 21l5.05-.94A8.97 8.97 0 0 0 12 21z M9.4 8.8c.16 0 .33 0 .47.34.16.39.55 1.36.6 1.46.05.1.08.22.01.35-.06.13-.1.21-.2.33l-.3.34c-.1.1-.2.21-.09.41.12.2.51.84 1.1 1.36.75.67 1.39.88 1.59.98.2.1.31.08.43-.05.12-.13.5-.58.63-.78.13-.2.26-.16.43-.1.18.07 1.13.54 1.32.63.2.1.32.14.37.22.05.08.05.47-.11.92-.16.46-.95.89-1.32.92-.37.04-.72.18-2.42-.5-2.05-.82-3.34-2.9-3.44-3.04-.1-.13-.82-1.1-.82-2.1 0-1 .53-1.49.71-1.69.18-.2.4-.25.53-.25z',
};
