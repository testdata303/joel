...
## 4. Learn pages - `/learn/business-phone-number`, `/learn/small-business-phone-system`

**Note (no-Google audit, July 2026):** the Educational Guide form (setup walkthroughs as standalone Learn pages) is RETIRED until `/help/` opens. Its one specimen, `/learn/call-forwarding-guide`, was folded into `features/call-forwarding` as a "Set it up" section (301). Setup content belongs on the feature page it configures, or in /help/ post-launch, never as a separate marketing page.
...
## 5. Startup pages - `/for/startups` (sole stage page; `/for/llcs`, `/for/solo-founders`, `/for/one-person-businesses` Rejected in the no-Google audit, July 2026 - one buyer, one page; LLC and solo angles are sections of startups)
